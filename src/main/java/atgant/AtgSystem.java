...
public class AtgSystem {
	...
	private void findModules(File currDir, String filePrefix, List<AtgModule> results, boolean recursive, boolean firstLevel) {
	...
	public AtgModule getModule(File currDir) throws IOException {
